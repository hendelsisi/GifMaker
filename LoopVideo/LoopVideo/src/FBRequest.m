...
//    {
//        NSError* error1 = [[NSError alloc]initWithDomain:@"" code:-1001 userInfo:nil];
//    [_delegate request:self didFailWithError:error1];
//    }
//    else
//    {
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
    ...
    // [_delegate request:_f didLoad:<#(id)#>]
